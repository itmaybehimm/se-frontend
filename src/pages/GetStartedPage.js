...
const GetStartedPage = () => {
    ...
    const loadSkills = useCallback(async () => {
        const loadSkillsUrl = BASE_URL + "/api/category/skills/"
        ...
        console.log(data) // Mug haru le data nai bigarera rakhethiyo data.data huna parne ho
        setSkillsList(data.data) // fixed here
    })
